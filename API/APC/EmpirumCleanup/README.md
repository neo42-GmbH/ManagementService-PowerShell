...
- Run: `.\01-List-Tenants.ps1 -ServerName "https://YourServer:Port"`
...
- Packages **without assignment but with install approval** (review carefully before deleting):
  - `.\02-Export-NoAssignmentInstallApproved.ps1 -ServerName "https://YourServer:Port" -TenantId "YourTenantId" -OutputPath "C:\Temp"`
- Packages **without assignment and without install approval** (the safest cleanup candidates):
  - `.\03-Export-NoAssignmentNoInstallApproved.ps1 -ServerName "https://YourServer:Port" -TenantId "YourTenantId" -OutputPath "C:\Temp"`
...
- Run:
  - `.\04-Cleanup-From-CSV.ps1 -ServerName "https://YourServer:Port" -TenantId "YourTenantId" -CsvPath "C:\Temp\NoAssignmentNoInstallApproved.csv" -CleanupAction NoAssignmentNoInstallApproved`
...
- Run:
  - `.\06-Cleanup-Filter-NoInstallApproved.ps1 -ServerName "https://YourServer:Port" -TenantId "YourTenantId" -FilterText "Adobe"`
...
- Run:
  - `.\05-Cleanup-Filter-InstallApproved.ps1 -ServerName "https://YourServer:Port" -TenantId "YourTenantId" -FilterText "Adobe"`
- Add `-DryRun` to preview first.
...
- Show all jobs for the tenant:
  - `.\07-Job-Status-Monitor.ps1 -ServerName "https://YourServer:Port" -TenantId "YourTenantId"`
- Watch one specific job until it finishes:
  - `.\07-Job-Status-Monitor.ps1 -ServerName "https://YourServer:Port" -TenantId "YourTenantId" -JobId "YourJobId"`
- Stay open and wait for new jobs:
  - `.\07-Job-Status-Monitor.ps1 -ServerName "https://YourServer:Port" -TenantId "YourTenantId" -StayActive`
